...
![Watchlist with store filters](assets/variant-tracking/watchlist-store-filter.png)
...
![Level Shoes with no selected size](assets/variant-tracking/level-shoes-selection-required.png)
...
![Level Shoes with size 48 selected](assets/variant-tracking/level-shoes-selected.png)
